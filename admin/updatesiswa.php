<?php
    ...
    include '../koneksi.php';
    $nim=$_GET['nim'];
    $data=mysqli_query($koneksi, "SELECT * FROM siswa WHERE nim='$nim' ") or die(mysqli_error($koneksi));
...
<body style="background-color : #F0FFFF;">
    ...
    <h1 class="text-center">Form Update Data Siswa</h1>
    <div class="container panel panel-default">
        <h3>Update Data Siswa</h3>
        <div class="panel-body">
        <form action="prosesupdatesiswa.php?nim=<?php echo $nim ?>" method="post" class="form">
